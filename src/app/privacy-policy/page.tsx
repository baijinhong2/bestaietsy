      ...
      <main className="py-12">
        <div className="mx-auto max-w-3xl px-6">
          ...
          <div className="prose-content">
            ...
            <ul>
              <li><strong>Alibaba Cloud DirectMail</strong> — Email delivery (ap-southeast-1 / Singapore). Sends transactional + newsletter emails on our behalf. Email addresses are passed through DirectMail at send time and not retained by Alibaba after delivery per their default policy.</li>
            ...
            <p>
              ...
              To request full data deletion, email <code>support@bestaietsy.com</code>.
            </p>
