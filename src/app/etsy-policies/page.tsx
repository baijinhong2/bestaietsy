...
import { policiesSeoContent } from "@/lib/seo/content/policies";
import { tdkToMetadata, faqJsonLd, jsonLdScript } from "@/lib/seo/metadata";

const tdkMeta = tdkToMetadata(policiesSeoContent) ?? {};
export const metadata: Metadata = {
  ...tdkMeta,
  alternates: { canonical: "https://bestaietsy.com/etsy-policies" },
  openGraph: {
    title: tdkMeta.title as string,
    description: tdkMeta.description as string,
    url: "https://bestaietsy.com/etsy-policies",
    type: "website",
    ...
    <>
      ...
      <main className="py-12">
        ...
        <section className="mt-20 pt-16 border-t-4 border-cream-200">
          <div className="mx-auto max-w-6xl px-6">
            <SeoSections content={policiesSeoContent} />
          </div>
        </section>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{ __html: jsonLdScript(faqJsonLd(policiesSeoContent) ?? {}) }}
        />
      </main>
      <SiteFooter />
    </>
